...
const stage3 = (b,f) => {
  ...
  createItems(b, f);
  const stage3enemy0 = createEnemies(0, 285, 30, 'sounds/bear_attack.mp3', 'sounds/bear_dead.mp3', 'url(imgs/bear_edit.png)');
  const takeDMG0 = stage3enemy0.takeDmg.bind(stage3enemy0);

  enemyDMG0.subscribe(takeDMG0);
  stage3enemy0.attack(stage3enemy0.dmg);

  const stage3enemy1 = createEnemies(1, 120, 110, 'sounds/librer_attack.mp3', 'sounds/librer_dead.mp3', 'url(imgs/libra_edit.png)');
  const takeDMG1 = stage3enemy1.takeDmg.bind(stage3enemy1);

  enemyDMG1.subscribe(takeDMG1);
  stage3enemy1.attack(stage3enemy1.dmg);

  const stage3enemy2 = createEnemies(2, 120, 110, 'sounds/librer_attack.mp3', 'sounds/librer_dead.mp3', 'url(imgs/libra_edit.png)');
